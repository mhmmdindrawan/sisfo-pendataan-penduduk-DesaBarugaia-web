...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Agu 2021 pada 11.29
...
INSERT INTO `tb_kk` (`id_kk`, `kaka`, `no_kk`, `kepala`, `desa`, `rt`, `rw`, `kec`, `kab`, `prov`) VALUES
(1, 'kk-2067.jpg', '1010202030304040', 'Juprianto', 'Majujaya', '01', '02', 'Semarang', 'Semarang', 'Jawa Tengahh'),
...
(6, 'kk-9677.jpg', '99aa', 'surini', 'surabaya', '01', '03', 'Sr1', 'Sr2', 'Sr3');
...
INSERT INTO `tb_pdd` (`id_pend`, `ktp`, `nik`, `nama`, `tempat_lh`, `tgl_lh`, `jekel`, `desa`, `rt`, `rw`, `agama`, `kawin`, `pekerjaan`, `status`) VALUES
