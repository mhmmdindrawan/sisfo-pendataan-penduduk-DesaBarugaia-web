...
<head>
	...
	<title>DATA PENDUDUK KECAMATAN BENTENG</title>
	<link rel="icon" href="">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="index.php" class="nav-link">
						<font color="white">
						<marquee><b>SISTEM INFORMASI PENDATAAN PENDUDUK KECAMATAN BENTENG</b></marquee>
						</font>
					</a>
				</li>
			</ul>
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-2 pb-2 mb-2 d-flex">
					...
					<div class="info">
						...
						<span class="badge badge-success bg-yellow">
							<?php echo $data_level; ?>
						</span>
					</div>
				</div>
